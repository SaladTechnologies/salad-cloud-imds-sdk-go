...
import (
	...
	"github.com/saladtechnologies/salad-cloud-imds-sdk-go/internal/contenttypes"
	"github.com/saladtechnologies/salad-cloud-imds-sdk-go/internal/serialization"
...
type Request struct {
	...
	Options             any
	Body                any
	Config              saladcloudimdssdkconfig.Config
	ContentType         ContentType
	ResponseContentType ContentType
}

func NewRequest(ctx context.Context, method string, path string, config saladcloudimdssdkconfig.Config) Request {
	return Request{
		Context:             ctx,
		Method:              method,
		Path:                path,
